...
// 	Joining_Position: {
// 		id: 'Joining Position',
// 		text: 'Joining Position',
// 		path: 'Joining Position',
// 		icon: 'sticky_note_2',
// 		subMenu: null,
// 	},
// 	Location: {
  ...
  Attendence: {
    ...
    subMenu: {
      listBoxed: {
        ...
        path: "hr/attendence/TodayAttendance",
        icon: "ViewArray",
      },
      listFluid: {
        id: "listFluid",
        text: "ALL AttedenceList",
        path: "hr/attendence/AttedenceList",
        icon: "ViewDay",
      },
      listFluids: {
        id: "listFluid",
        text: "Employee Attedence",
        path: "hr/Employee",
        icon: "ViewDay",
      },
    },
  ...
  Empoloyees: {
    ...
    subMenu: {
      ...
      listFluid: {
        id: "listFluid",
        text: "Employee List",
        path: "hr/Employee/Employee-List",
        icon: "ViewDay",
      },
    },
  },
