...
// import AttedenceList from '@/common/partial/AttedenceList';
import AllAttedenceList from '@/common/partial/AllAttedenceList';

const AttedenceList: NextPage = () => {
	...
	return (
		<PageWrapper>
			...
			<SubHeader>
				<SubHeaderLeft>
					<span className='h4 mb-0 fw-bold'>Today Attedence</span>
					<SubheaderSeparator />
