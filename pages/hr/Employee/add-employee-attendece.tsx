...
import FaceRegistration from '@/components/FaceRegistation';

const AddEmployeeForAttedence: NextPage = () => {
		...
		<PageWrapper>
			...
			<SubHeader>
				<SubHeaderLeft>
					...
					<SubheaderSeparator />
					<strong>Add  Employee Attedence</strong> &nbsp;(&nbsp;{dayjs().format("DD MMM YYYY")}&nbsp;)
				</SubHeaderLeft>
			</SubHeader>
...
export default AddEmployeeForAttedence;
